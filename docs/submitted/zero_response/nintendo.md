...
Saint Paul, MN &nbsp;|&nbsp; 507-299-0445 &nbsp;|&nbsp; caleb.m.kopp@outlook.com &nbsp;|&nbsp; [linkedin.com/in/calebmkopp](https://linkedin.com/in/calebmkopp)
...
- Implemented features in custom Kubernetes operators (Go) for automated resource deployment at production scale. Managed cloud infrastructure via Terraform and GitOps workflows. Migrated CI/CD pipelines from Jenkins and Ansible to GitHub Actions. Assumed SRE responsibilities, stabilizing production services and running on-call incident response.

- Built a full-stack web application (React, TypeScript, Express, MSSQL) replacing spreadsheet-based datacenter server inventory management with a standardized naming and tracking system. Demoed to stakeholders and adopted by the team.
